                    ...
                    <ul class="col pagination justify-content-center" style="margin: 20px 0;">
                        <?php
                            for($num_page = 1; $num_page <= $total_page; $num_page++){
                                if($num_page == $page ){
                                    echo '<li class="page-item active"><a class="page-link" href="tablet.php?page='.$num_page.'">'.$num_page.'</a></li>';
                                }else{
                                    echo '<li class="page-item "><a class="page-link" href="tablet.php?page='.$num_page.'">'.$num_page.'</a></li>';
                                }
                            }
                        ?>
                    </ul>
